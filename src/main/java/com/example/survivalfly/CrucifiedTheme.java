...
public class CrucifiedTheme {
    ...
    public static int getPrimaryColor() {
        ...
        switch (theme) {
            case "Sea": return 0xFF00BFFF;
            case "Sun": return 0xFFFF7F00;
            case "OLED": return 0xFF444444;
            case "Flash": return 0xFFFFFFFF;
            case "Natural": return 0xFF228B22;
            case "Rock": return 0xFF708090;
            default: return 0xFFFF007F;
        }
    }
    ...
    public static int getSecondaryColor() {
        String theme = getCurrentTheme();
        switch (theme) {
            case "Sea": return 0xFF00FFFF;
            case "Sun": return 0xFFFFD700;
            case "OLED": return 0xFF666666;
            case "Flash": return 0xFFCCCCCC;
            case "Natural": return 0xFF32CD32;
            case "Rock": return 0xFFA9A9A9;
            default: return 0xFFFF69B4;
        }
    }
